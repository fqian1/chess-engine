...
quick|q)
    ...
    ;;
legal_masked|lm)
    ./target/release/chess-engine -l -m -a -p "./tmp/legal_masked/model.mpk" -g 512
    ;;
legal_unmasked|lu)
    ./target/release/chess-engine -l -a -p "./tmp/legal_unmasked/model.mpk" -g 512
    ;;
pseudo_legal_masked|pm)
    ./target/release/chess-engine -m -a -p "./tmp/pseudo_masked/model.mpk" -g 512
    ;;
pseudo_legal_unmasked|pu)
    ./target/release/chess-engine -a -p "./tmp/pseudo_unmasked/model.mpk" -g 512
    ;;
